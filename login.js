...
loginForm.addEventListener('submit', (event) => {
  ...
  if (loginEmail === '') {
    loginEmailError.textContent = 'Please enter a valid email, email can not be empty';
    formIsValid = false;
  } else {
    loginEmailError.textContent = '';
  }
  ...
  if (loginPassword === '') {
    loginPasswordError.textContent = 'Please enter your password, password can not be empty';
    formIsValid = false;
  } else {
    loginPasswordError.textContent = '';
  }
